...
func main() {
	...
	fonts := []*tinyfont.Font{&notoemoji.NotoEmojiRegular12pt, &notoemoji.NotoEmojiRegular16pt, &notoemoji.NotoEmojiRegular20pt}
	for i, f := range fonts {
	...
	fontHeight := int16(font.Glyphs['0'-font.YAdvance].Height)
	...
	for {
		...
		msg := fmt.Sprintf("%02d:%02d", hour, minute)
